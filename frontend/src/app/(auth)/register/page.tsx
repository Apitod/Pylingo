        ...
        <main className="min-h-screen bg-duo-bg flex items-center justify-center p-6">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-duo-text mt-2">Start your Python learning journey</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-duo-text text-sm mb-2">Username</label>
                        <input
                            type="text"
                            value={username}
                ...
                <p className="text-center text-duo-text mt-6">
                    ...
                    <Link href="/login" className="text-duo-blue hover:underline font-bold">
                        Log in
                    </Link>
                </p>
            </div>
